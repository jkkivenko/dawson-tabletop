...
A Character's Capabilities are a combination of their [[Class]] and their [[Skills]]. Their Class represents what they spend most of their time doing, and might even represent their profession or hobby. On the other hand, a Character's Skills represent their nuanced knowledge, personality traits, and personal fascinations that can come in handy and change the way they interact with the world. When designing a Character, pick a Class from the list and one Skill to start. When you gain Class Tree Points, allocate them to the Class Tree outlined in your chosen Class. Skill Tree Points, unlike the other three types of Tree Points, are not restricted by a Class, Society, or Physiology. Any Character can choose to allocate points anywhere on the Skill Tree as long as they meet the requirements.
